...
<html>
	<head>
		...
		.ui-widget-content{}
		.ui-tabs { }
		.ui-tabs .ui-tabs-panel { padding: 1em 0em 1em 0em; display: block; border-width: 0; background: none; }
		</style>
		<!-- 样式文件 -->	
		${linkcss}
		<!-- 时间控件脚本 -->
	...
	<body style="background-color: #F2F5F7;">
		<center >
			...
			<div align="center" style="background-color: #fff;padding:20px 10px 10px 10px; width:920px;border: 1px #DDDDDD solid; ">
