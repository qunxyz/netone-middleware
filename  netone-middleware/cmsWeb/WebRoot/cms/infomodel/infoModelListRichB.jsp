...
-->
	...
	<body LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0
		style="font:14px">
		<form action="infomodellistRich.do?levelId=2" name="form1"
			method="post">
					...
					<logic:present name="cmsinfomodellist">
						<logic:iterate id="row" name="cmsinfomodellist">
							<tr>
								...
								<td width='15%' width='70' align='center'>
									<IMG
								...
								<td width='85%'>
									...
									<a href='http://www.oesee.cn/vi/<bean:write name='row'  property='participant'/>/'
