				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						...
						<td colspan='1'>
							...
							<input type="button" name="btndelete" value="新建钻取层"
								onclick="newds1()" class="butt">			
						...
						<td colspan='9' align='right' nowrap>
							...
							<script type="text/javascript">
								...
								function newds1(){
									...
									window.open('<portal:envget envkey="WEBSER_SpeedyForm"/>/BiAnalysis.html ','_blank');
								}
								function edits(){
									var k = 0;
									var value;
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
									...
									<a
										href="javascript:window.open('<portal:envget envkey="WEBSER_SpeedyForm"/>updatezpform.html?pid=${list.id}','_parent');"
