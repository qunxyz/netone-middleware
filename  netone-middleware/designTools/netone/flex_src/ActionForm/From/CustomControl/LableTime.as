...
package ActionForm.From.CustomControl
{
	...
	import mx.core.*;
	public class LableTime extends UIComponent
	{
		public static  var _lable:Label;	
	    public  var _timeinput:TimeInput2;
   ...
   protected override function createChildren():void{
		super.createChildren();
	 		      ...
	 		      _timeinput=new TimeInput2();
	 		      _timeinput.width=_lable.width*3;
	 		      _timeinput.height=_height;
	 		      _timeinput.x= _lable.width+_lable.x;
	 		      _timeinput.y=0;
	 		      addChild(_timeinput);

	 		this.width=_lable.width+_timeinput.width;
	 		this.height=_height;  
	 		var i:int=Math.round(Math.random()*(2000-1000))+1000;   
	 		this.name="LableTime"+i;
	 		this.id="02";
		}
		  ...
		  public override  function set width(width:Number):void{
		     ...
		     _timeinput.width=_lable.width*3;
		   /*  _timeinput.getChildByName("startDF").width=(width-_lable.width)/2;
		     _timeinput.getChildByName("tInput").width= (width-_lable.width)/2; */
