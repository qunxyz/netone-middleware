package ActionForm.From.CustomControl
{
	...
	import mx.core.*;
public class LableComboBoxKV extends UIComponent
	{
		public static  var _lable:Label;	
	    public  var _combobox:ComboBox=new ComboBox();
		...
		super.createChildren();
	 	         ...
	 	         addChild(_lable);
	 		      ...
	 		      _combobox.y=0;
	 		       ...
	 		       addChild(_combobox);
	 		this.width=_lable.width+_combobox.width;
	 		this.height=_height;  
