...
import com.report.chart.pie.impl.Pie3DImpl;
 ...
 * @history
 */
public class Pie3DTest {

	public static JFreeChart todo() {
		// 1.创建实例对象
		PieIfc pie = new Pie3DImpl();
		...
		JFreeChart chart = pie.createChart("Pie Chart 3D Demo ", pieDataset);
	...
	public static void main(String[] args) {
		...
		ChartCommon.saveChartAsJPEG("Pie3DChart.jpg", todo());
	}
