...
function writeIframe(){
	...
	for(var h=0; h<24; h++){strIframe+="<option "; if(WebCalendar.inputHour==parseInt(h))strIframe+="selected";strIframe+=" value='"+h+"'>"+((h<10)?("0"+h):h)+"</option>  ";}
	strIframe+= "</select>时 <select name='dsminute' style='font-size:12px;width:36px' onChange=\"parent.WebCalendar.inputMinute=this.value;\">";
   	for(var m=0; m<60; m++){strIframe+="<option ";	if(WebCalendar.inputMinute==parseInt(m))strIframe+="selected";strIframe+=" value='"+m+"'>"+(m<10?"0"+m:m)+"</option>  ";}
