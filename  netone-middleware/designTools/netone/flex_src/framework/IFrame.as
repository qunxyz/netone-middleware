	...
	public class IFrame extends Container
	{
        ...
        */
        private static var FUNCTION_CREATEIFRAME:String = 
         ...
         private static var FUNCTION_zIndex:String = 
            "document.insertScript = function ()" +
        	"{ " +
                "if (document.zIndex==null)" + 
                "{" + 
                    "zIndex = function (frameID,index)" +
                	"{ " +
                        "document.getElementById(frameID).style.zIndex=index;"+                 
                    "}" +
                "}" +
            "}";
        ...
        */
        override protected function createChildren():void
        {
            ...
            ExternalInterface.call(FUNCTION_zIndex);
