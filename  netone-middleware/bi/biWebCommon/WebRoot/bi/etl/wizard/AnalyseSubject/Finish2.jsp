...
<HTML>
	<HEAD>
		...
		<SCRIPT TYPE="text/javascript">
			...
			function forward(){
				//history.go(-1);
				document.additem.action="<%=path%>/NextAnalyse.do?task=Modify&chkid="+document.all.chkid.value;
	    	...
	    	function analyse(){
	    		if(checkseldim()){
					...
					document.all.str.value = str;
					document.all.additem.action="<%=basePath%>flowpage.do?chkid="+document.all.chkid.value+"&act=table&task=chart0&task2=analyse2";
	...
	<BODY bgcolor="#FFFFFF">
		<FORM ACTION="<%=path%>/ModifyAnalyse.do?task=doFinish2" METHOD="POST"
			name="additem">
			...
			<DIV
				...
				<table width="90%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr class="td-02">
						...
						<td bgcolor="#FFFFFF" align="left">
							<select name="showactive">
								<option value="1" ${fo.showactive==1? "selected":fo.showactive==""?"selected":""}>
									是
								</option>
					...
					<tr class="td-02">
						...
						<td bgcolor="#FFFFFF" align="left">
							<input type="radio" value="0" name="multichart" ${fo.multichart==
								"0"?"checked":fo.multichart==""?"checked":""}>
							否
							<input type="radio" value="1" name="multichart" ${fo.multichart=="1"?"checked":""}>
							是
						</td>
					</tr>
					<tr class="td-02">
						...
						<td bgcolor="#FFFFFF" align="left">
							...
							<input type="text" value="${fo.piccolor }" name="piccolor"
								style="width: 100">
							&nbsp; X轴文字倾斜值
							<input type="text" value="${fo.xqingxie }" name="xqingxie" style="width: 100">
						</td>
					</tr>
				</table>
				<!-- End --Body---- 功能内容定义  --->
