...
///////////////////////////////////////////////////////////////////////////////
var webFXTreeConfig = {
	rootIcon        : "rsinclude/images/folder.png",
	openRootIcon    : "rsinclude/images/openfolder.png",
	folderIcon      : "rsinclude/images/folder.png",
	openFolderIcon  : "rsinclude/images/openfolder.png",
	fileIcon        : "rsinclude/images/folder.png",
	iIcon           : "rsinclude/images/I.png",
	lIcon           : "rsinclude/images/L.png",
	lMinusIcon      : "rsinclude/images/Lminus.png",
	lPlusIcon       : "rsinclude/images/Lplus.png",
	tIcon           : "rsinclude/images/T.png",
	tMinusIcon      : "rsinclude/images/Tminus.png",
	tPlusIcon       : "rsinclude/images/Tplus.png",
	plusIcon        : "rsinclude/images/plus.png",
	minusIcon       : "rsinclude/images/minus.png",
	blankIcon       : "rsinclude/images/blank.png",
...
function WebFXTreeAbstractNode(sText, oAction) {
	...
	//hls
	if(sText){
		var icb = sText.indexOf("{cb}");
		var itt = sText.indexOf("{tt}");
		if(itt!=-1){
			this.checkbox = sText.substring(icb+4,itt);
			this.text = sText.substring(itt+4);
		}
	}
...
_p.getLabelHtml = function () {
	...
	//hls
	var labtext = this.getHtml();
	var lablehtml = "<a href=\"" + webFXTreeHandler.textToHtml(this._getHref()) +
	...
	if(this.checkbox != undefined ){
		var checked ="";
		var disabled = "";
		if(this.checkbox==1 || this.checkbox==3){
			checked = "checked";
		}
		if(this.checkbox > 1){
			disabled = "disabled";
		}
		lablehtml = lablehtml + "<input type='checkbox'"+checked+" "+disabled+"/>"
		            +labtext + "</a>";
	}
	else{
		lablehtml = lablehtml + labtext + "</a>";
	}
...
_p.setHtml = function (s) {
	...
	//hls
	var icb = s.indexOf("{cb}");
	var itt = s.indexOf("{tt}");
	if(itt!=-1){
		this.checkbox = s.substring(icb+4,itt);
		this.text = s.substring(itt+4);
			
		var el = this.getLabelElement();
		if (el) {
			el.innerHTML = s.substring(itt+4);
	  	}
	}
	else{
		this.text = s;	
...
_p._onclick = function (e) {
	...
	if (typeof this.action == "function") {
		...
		//hls,需要导入exttree2.js文件
		if(this.checkbox != undefined){
			changeCbxChecked(this);
		}
