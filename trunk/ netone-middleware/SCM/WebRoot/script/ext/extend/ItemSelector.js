...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    delimiter:',',
    readOnly:false,
    dragDrop:false,//don add是否支持drag&drop   false:支持;true:不支持
    toLegend:null,
    fromLegend:null,
    toSortField:null,
    fromSortField:null,
    ...
    onRender: function(ct, position){
        ...
        this.fromMultiselect = new Ext.ux.Multiselect({
            ...
            */
            dragGroup: this.dragDrop ? null : "drop2-"+this.el.dom.id,
            dropGroup: this.dragDrop ? null : "drop1-"+this.el.dom.id,
        ...
        this.toMultiselect = new Ext.ux.Multiselect({
            ...
            */
            dragGroup: this.dragDrop ? null : "drop1-"+this.el.dom.id,
            //dropGroup: this.readOnly ? null : "drop2-"+this.el.dom.id+(this.toSortField ? "" : ",drop1-"+this.el.dom.id),
            dropGroup: this.dragDrop ? null : "drop2-"+this.el.dom.id+",drop1-"+this.el.dom.id,
            width: this.msWidth,
            height: this.msHeight,
            displayField: this.displayField,
            valueField: this.valueField,
