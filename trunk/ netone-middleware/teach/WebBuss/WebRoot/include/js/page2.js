...
PageInfo.prototype.write=function(){
	if(this.itemCount){
	    var xxx1= this.perPage*this.pageCount;
	    var xxx2= this.nowpage*this.pageCount;
		document.writeln("本页显示第"+xxx1+"到"+xxx2);
		...
		document.writeln('<a href="javascript:_this.gotopage();">跳转</a><input type="text" id="page_selpage" name="page_selpagex" value="" style="width:20"  onkeydown="if(event.keyCode==13) {_this.gotopage();}">');
