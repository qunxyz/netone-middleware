				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							...
							&nbsp;
							<input type="button" value="数据采集" onclick="newds()" class="butt">
							&nbsp;
							<input type="button" value="数据迁移" onclick="newds1()" class="butt">
				...
				<table id="hang_table" width="96%" border="0" align="center"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								<c:if test="${list.objecttype=='trans'}">数据迁移 </c:if>
								<c:if test="${list.objecttype=='etl'}">数据采集 </c:if>
							</td>
							<td nowrap>
								${list.created}
							</td>
