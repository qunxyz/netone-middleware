					 ...
					 items:[
						...
						**/
						...
						,{
						  ...
						  iconCls:"resetIcon",
						  handler: function (){
								var cm = Ext.getCmp('PlanGrid').getColumnModel();
								for (var o = 0; o < cm.getColumnCount(); o++) {
									alert(cm.getDataIndex(o)+":"+cm.isHidden(o));
								}
						  }
						}
						**/
...
function $printexcel(){
    ...
    var lsh = selectionSet[0].get('lsh');
	var url = "<c:url value='/frame.do?method=onPrintViewMain' />"+"&excel=1&naturalname=${param.naturalname}&lsh="+lsh;
	if (lsh!='') window.open(url);
}
