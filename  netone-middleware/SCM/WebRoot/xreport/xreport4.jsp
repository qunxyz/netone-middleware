	...
	border-top: 1px dashed #E3E3E3;
		...
		/***
		    ...
		    **/
			...
			form1.action="<c:url value='/reportx1.do?method=query' />"+formatstr;
			form1.target="_blank";
			form1.method="POST";
			form1.submit();
			/***
					...
					<div id="tabs-1">
						...
						<form id="_xreport_form">
							<input type="hidden" id="naturalname" name="naturalname"
								value="REPORTQ.REPORTQ.FXGL.FXJHTJB" unselectable="off"
								onFocus="this.select()" />
										...
										<div class="form_fieldcontent" style="width: 392px">
											...
											<div class="form_fieldinput" style="width: 344px;"
												...
												<select id="repselect1" name="repselect1"
													...
													<option value="tbfxscsyhB">
														调拨分销商测试用户B
													</option>
													<option value="dfadfaad">
														调拨分销商测试用户C
													</option>
												</select>
											</div>
										...
										<div class="form_fieldcontent" style="width: 196px">
											...
											<div class="form_fieldinput" style="width: 124px;"
												...
												<select id="repselect5" name="repselect5"
													...
													<option value="111111111">
														111111111111111
													</option>
													<option value="萨菲瓦而发玩儿">
														的风格大方过
													</option>
													<option value="11">
														111
										...
										<div class="form_fieldcontent" style="width: 196px">
											...
											<div class="form_fieldinput" style="width: 160px;"
												...
												<select id="repselect6" name="repselect6"
													...
													<option value="0010101">
														透明
													</option>
													<option value="第三方归属感和收入提高">
														威锋网122353465
													</option>
													<option value="1111111">
														1111
													</option>
													<option value="11111">
														11112
