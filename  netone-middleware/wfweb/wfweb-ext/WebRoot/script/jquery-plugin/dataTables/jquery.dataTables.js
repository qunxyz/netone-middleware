 ...
 * Version:     1.6.0
 * CVS:         $Id: jquery.dataTables.js,v 1.1 2010/02/09 07:34:05 chenjx Exp $
 * Description: Paginate, search and sort HTML tables
 * Author:      Allan Jardine (www.sprymedia.co.uk)
 * Created:     28/3/2008
 * Modified:    $Date: 2010/02/09 07:34:05 $ by $Author: chenjx $
 * Language:    Javascript
...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		this.fnVersionCheck = function( sVersion )
		{
			...
			return parseInt(sThis) >= parseInt(sThat);
		};
		...
		function _fnDraw( oSettings )
		{
			 ...
			 * are nested tables then we don't want to remove those elements. Note that this is faster
			 * (about 1% faster) than using $().empty() - hence the use of the loop here
			 */
