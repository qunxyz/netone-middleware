...
<html>
	...
	<body>
	<center>
	<form id="formx" action="<c:url value='/app.do?method=exportsellinfo' />" target="_blank" method="post">
		<p id="conditionDiv">
		日期：
		...
		<p>
		客户名称:<input id="FSupplyIDName" name="FSupplyIDName" />
		</p>
		<p>
