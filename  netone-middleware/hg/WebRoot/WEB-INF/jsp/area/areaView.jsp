...
<html>
	...
	<body>
	     ...
	     <div id="bussTypeDiv">
	     	显示节点:
	     	<select id="l" name="l" onchange="refresh()">
	     		<option value="">显示所有</option>
	     		<!-- 
	     		<option value="1">显示省公司</option>
	     		<option value="2">显示大营销部</option>
	     		<option value="3">显示营销部</option>
	     		 -->
	     		<option value="4" selected="selected">显示经销商</option>
	     		<option value="5">显示分销商</option>
	     	</select>
	     </div>
	     <div id="listDiv">
	     	是否显示所有隶属:
