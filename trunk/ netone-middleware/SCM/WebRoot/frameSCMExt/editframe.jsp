  ...
  return this;
	...
	$(function() {
		...
		|| '${param.naturalname}'=='APPFRAME.APPFRAME.JEWELRY.JEWELRY.JEWELRYAPP20'
			...
			Ext.getCmp('ext_b_delete').hide();
			Ext.getCmp('ext_b_cancel').hide();
		}
	});
...
function _print(){
	var url = "<c:url value='/frame.do?method=onPrintViewMain' />"+"&naturalname=${param.naturalname}&lsh=${param.lsh}";
	window.open(url);
}
