  ...
  ProductCategories.Layout.Viewport =  Ext.extend(Ext.Viewport, {
   ...
   Ext.onReady(function(){//页面加载时候触发事件
	...
	refresh = function(){//刷新
		...
		var productCategoriesGrid3  = viewport.findById('ProductCategoriesGrid');//Grid
		if (productCategoriesGrid3.store.lastOptions!=null){
			start = productCategoriesGrid3.store.lastOptions.params.start;
		} else {
			start = 0;
		}
    	productCategoriesGrid3.store.load({params:{start:start, limit:15}});//刷新当前页面
	};
