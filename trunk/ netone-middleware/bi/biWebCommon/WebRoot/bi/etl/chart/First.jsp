...
<HTML dir="LTR" lang="zh-CN">
	...
	<BODY bgcolor="#FFFFFF">
		<FORM ACTION="<%=path%>/NextChart.do?task=Next" METHOD="POST"
			name="additem">
							...
							<TABLE WIDTH="100%" BORDER="0" CELLPADDING="1" CELLSPACING="0">
								<TR CLASS="OecBgColorDark">
									...
									<TD WIDTH="100%" valign="center">
										<FONT CLASS="OecGlobalPageTitle">主题分析向导</FONT>
									</TD>
			...
			<DIV
				...
				<hr>
				<br>
				<FONT CLASS="OecInstructionText">帮助提示:名称是该主题分析的唯一识别名,请使用英文来填写。
					然后单击“下一步”。</FONT>
				<!-- End --Title----功能标题与提示---->
				<BR>
				...
				<div style="width: 100%; height: 100%; border: 1 solid #A9C0E5;">
					<table>
						<tr>
							...
							<td>
								<input type="text" name="naturalname" value="${fo.naturalname}"
									size='30'>
								<font color='red'>${error}</font> [格式：字母开头后接字母或数字或下划线]
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" name="name" value="${fo.name}" size='30'>
							</td>
						</tr>
					</table>
					<!-- End--Body---- 功能内容定义  --->
