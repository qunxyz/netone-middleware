...
public class ZipUtil {
	...
	public static void main(String[] arg) throws Exception {
		...
		// //Ñ¹ËõÎÄ¼þ¼Ð
		// zip("c:/abc.zip",new File("c:/abc"),false);
	}

	public ZipUtil() {
	}

	public static void zip(String s, String s1) throws Exception {
		zip(s, s1, false);
	}

	public static void zip(String s, String s1, boolean flag) throws Exception {
		zip(s, new File(s1), flag);
	}

	public static void zip(String s, File file, boolean flag) throws Exception {
	...
	public static void zip(String s, File file) throws Exception {
		zip(s, file, false);
	}

	public static void unzip(String s, String s1) throws Exception {
	...
	private static void zip(ZipOutputStream zipoutputstream, File file,
			String s, boolean flag) throws Exception {
		if (file.isDirectory()) {
