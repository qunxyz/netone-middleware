  ...
  <BODY bgcolor='#999999'>
 	<form action="<%=submitpath%>" method="post">
     	...
     	<input type="hidden" name="todo" value="${todo}">
		      ...
		      <table width="300" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:9pt">
		      	<tr>
		      		<td colspan="3">
		        ...
		        <tr> 
		          <td width="23%" height="35" align="right"> ÕÊ»§Ãû£º </td>
		          <td width="42%"> <input name="username" type="text"
		          ...
		          <td width="35%" align="center">
		          	<input type="submit" value="µÇÂ½" style="width:57px;height:20px;" />	          		

		          </td>
		          <td>
		          		 <input type="button" value="×¢²á" target='_blank' onClick="window.open('http://125.77.121.17:8000/securityweb/oec/forum/regeditview.do');" style="width:57px;height:20px;" />	          		

		          </td>
		        </tr>
		        <tr>
		          <td height="35" align="right"> ÃÜ&nbsp;&nbsp;Âë£º</td>
		          <td>
		            <input name="password"  type="password"
		            style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; WIDTH: 110px; BORDER-BOTTOM: #000000 1px solid; HEIGHT: 19px; " 
		            tabindex=1 ></td>
		          <td align="center">
		          	<input type="reset" value="È¡Ïû" style="background-image:url(width:57px;height:20px;" />
		          </td>
		        </tr>
		    </table>
	</form>
