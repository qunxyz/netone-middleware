			...
			for(var i=0 ; i<users.length ; i++){
				if(users.options[i].selected){
					...
					for(var j=0;j<length;j++){
						...
						if(users.options[i].value==document.getElementById("result").options[j].value){
							b=false;
					...
					if(b){
						...
						document.getElementById("result").options.add(new Option(users.options[i].text,users.options[i].value));
					}
				}
			}
		}
						...
						<table border="0" width="90%" height="80%"
							...
							<tr>
								...
								<td align="center" valign="top">
									<select size="18" name="users" id="users" style="width: 150px"
										multiple="multiple">
									</select>
								</td>
								...
								<td align="center" valign="top">
									<select size="18" name="result" id="result" style="width: 150px"
										multiple="multiple">
									</select>
								</td>
							</tr>
