...
/**
 * 角色Dao实现(关于UmsRole2role2)
 * 
 * @author ni.he.qing
 * 
 */
public class RoleDaoImplrole implements RoleDao {
	...
	public boolean create(Object obj) {
		...
		UmsRole2role2 urolerole = (UmsRole2role2) obj;
		return OrmerEntry.fetchOrmer().fetchSerializer().create(urolerole);
	}
	...
	public boolean creates(List objs) {
		...
		List<UmsRole2role2> list = new ArrayList<UmsRole2role2>();
		for (Iterator iter = objs.iterator(); iter.hasNext();) {
			UmsRole2role2 urolerole = (UmsRole2role2) iter.next();
			list.add(urolerole);
		}
	...
	public boolean drop(Object obj) {
		...
		UmsRole2role2 urolerole = (UmsRole2role2) obj;
		return OrmerEntry.fetchOrmer().fetchSerializer().drop(urolerole);
	}
	...
	public boolean update(Object obj) {
		...
		UmsRole2role2 urolerole = (UmsRole2role2) obj;
		return OrmerEntry.fetchOrmer().fetchSerializer().update(urolerole);
	}
	...
	public List queryObjects(Object obj, Map comparisonKey) {
		...
		UmsRole2role2 urole = (UmsRole2role2)obj;
