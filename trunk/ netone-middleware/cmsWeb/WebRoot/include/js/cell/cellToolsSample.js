...
function editmodel() {
	...
	window.open(url, "_blank", "width=800,height=600,left=300,top=100,resizable=yes");
}
function testEle() {
	var id = $("cellid").value;
...
function addEleCore(selegroupValue) {
	window.open("/cmsWeb/blog/AddPage.jsp?modelid="+modelid, "_BlkDsa", "height=500, width=500, top=200, left=300, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no");
}

function addEleCore(selegroupValue,path) {
	window.open("/cmsWeb/blog/AddPage.jsp?pagepath="+path, "_BlkDsa", "height=500, width=500, top=200, left=300, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no");
}
...
function manelementlist(path){
	window.open('/cmsWeb/PagelistpathRightSvl?pagename=page&appname='+path,'_pagelist');
 
}
/** 选择模版 don add 09-3-12*/
function selectlist(path){
	window.open('/cmsWeb/PagelistpathRightSvl?pagename=page&appname='+path,'_pagelist2');
