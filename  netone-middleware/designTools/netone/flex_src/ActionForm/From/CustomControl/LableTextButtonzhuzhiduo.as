package ActionForm.From.CustomControl
{
	...
	import mx.core.*;
	public class LableTextButtonzhuzhiduo extends UIComponent
	{
		...
		public var _type:String="组织人员多选";
   ...
   protected override function createChildren():void{
		super.createChildren();
	 		...
	 		this.name="LableTextButtonzhuzhiduo"+i;
	 		this.id="23";
		}
