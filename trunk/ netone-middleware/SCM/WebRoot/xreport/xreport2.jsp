	...
	border-top: 1px dashed #E3E3E3;
		...
		/***
		    ...
		    **/
			...
			form1.action="<c:url value='/report.do?method=query' />"+formatstr;
			form1.target="_blank";
			form1.method="POST";
			form1.submit();
			/***
				...
				<div id="tabs" style="height: 100%;">
								...
								<tr class="form_tr" unselectable="off" onFocus="this.select()">
									<td class="form_td" unselectable="off" onFocus="this.select()"
										...
										<div class="form_fieldcontent" style="width: 392px">
											<div class="form_fieldcaption" align="left" title="统计日期"
												style="width: 48px;">
												统计日期:
											</div>
					...
					<div id="tabs-2">
						<table border="0" align="center">
								<tr>
									<td>
										<input type="radio"  id="_REPORTIDKEY" name="_REPORTIDKEY"    unselectable="off" onFocus="this.select()"   checked="checked"  />&nbsp;收支余额统计表
									</td>
								</tr>
							<tr>
								<td>
