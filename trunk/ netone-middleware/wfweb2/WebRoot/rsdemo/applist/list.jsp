...
<html>
	<head>
		...
		//显示
		function viewthismulti(id) {
			window.open("MSelectSvl?appid="+id+"&pagename="+document.all.pagename.value);
		}
		//显示
		function viewthissingle(id) {
			window.open("SSelectSvl?appid="+id+"&pagename="+document.all.pagename.value);
		}
		</script>
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								...
								<a
									href="javascript:checkthis('${list.id}','${list.naturalname}','${list.name}');">选择</a>
								<a href="javascript:viewthis('${list.id}');">选择树</a>
								<a href="javascript:viewthismulti('${list.id}');">多选择</a>
								<a href="javascript:viewthissingle('${list.id}');">单选择</a>
								<a
									href="javascript:managerthis('${list.naturalname}','path','pagelist');">管理</a>
								<a
									href="javascript:managerthis('${list.naturalname}','','pagelist');">管理</a>
							</td>
						</tr>
					</c:forEach>
				</table>
