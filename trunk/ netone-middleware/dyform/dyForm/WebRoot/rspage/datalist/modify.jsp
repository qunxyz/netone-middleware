...
<html>
	<head>
		...
		function  addselect(name){
			document.all.objecttype.value = name;
		}
		</script>
	</head>
			...
			<form action="PagelistModifySvl?task=editsave" method="post"
				...
				<table width="96%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td width='300'>
							<input type="text" name="objecttype" value="${upo.objecttype}" id="objecttype"
								class="textinput_td" readonly="readonly"> <!-- 增加id值 2009-2-17 -->
						</td>
					</tr>
				...
				<div align="center">
					<input type="button" name="btnnew" value="修 改" class="butt" onClick='modifythis()'>
