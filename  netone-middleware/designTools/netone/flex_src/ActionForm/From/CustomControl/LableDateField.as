...
package ActionForm.From.CustomControl
{
	...
	import mx.core.*;
	public class LableDateField extends UIComponent
	{
		public static  var _lable:Label;	
	    public  var _datefield:DateField;
   ...
   protected override function createChildren():void{
		super.createChildren();
	 		      ...
	 		      _datefield.width=_lable.width*3;
	 		      _datefield.height=_height;
	 		      _datefield.x= _lable.width;
	 		      _datefield.y=0;
	 		       addChild(_datefield);
	 		this.width=_lable.width+_datefield.width;
	 		this.height=_height;  
	 		var i:int=Math.round(Math.random()*(2000-1000))+1000;   
	 		this.name="LableDateField"+i;
	 		this.id="03";
		}
