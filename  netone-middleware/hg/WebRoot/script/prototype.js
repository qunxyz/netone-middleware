 ...
 * @alias Function.prototype.bindAsEventListener
...
Object.extend(Event, {
  ...
  */
  ...
  /**
   * Code for the Insert key. Constant.
   * @memberOf {Event}
   */
  KEY_INSERT:   45,
...
var Insertion = {
  ...
  /**
   * Inserts HTML right after the closing tag of an element.
   * @alias Insertion.After
   * @param {Object} element
   * @param {Object} content
   */
