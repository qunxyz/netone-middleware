...
public class FrameAction2 extends AbstractAction {
	...
	public ActionForward onMainView(ActionMapping mapping, ActionForm form,
		...
		String columns = DyFormBuildHtml2.buildExtColumns(dyform, "1", true);
		String fields = DyFormBuildHtml2.buildExtFields(dyform);
		request.setAttribute("columns", columns);
		request.setAttribute("fields", fields);
		String queryColumnHtml = DyFormBuildHtml2.buildQueryColumn(dyform
				.getQueryColumn_());
		request.setAttribute("queryColumnsHtml", queryColumnHtml);
		String queryConditionHtml = DyFormBuildHtml2.buildQueryCondition(dyform
				.getQueryColumn_());
	...
	public ActionForward onMainView2(ActionMapping mapping, ActionForm form,
		...
		String subcolumns = DyFormBuildHtml2.buildExtColumns(subdyform, null,
				true);
		String subfields = DyFormBuildHtml2.buildExtFields(subdyform);
	...
	private void load(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			request.setAttribute("AvailWidth", DyFormBuildHtml2.AvailWidth
					- DyFormBuildHtml2.AvailWidthCorrect);
			if (StringUtils.isNotEmpty(workcode)) {
			...
			request.setAttribute("ValidateScript", DyFormBuildHtml2
	...
	public ActionForward onMainViewExt(ActionMapping mapping, ActionForm form,
		...
		request.setAttribute("limit", new DyForm().getEachPageSize_());
		DyForm dyform = DyEntry.iv().loadForm(formcode);
		String columns = DyFormBuildHtml2.buildExtColumns(dyform, "2", isedit);
		String fields = DyFormBuildHtml2.buildExtFields(dyform);
		request.setAttribute("columns", columns);
		request.setAttribute("fields", fields);
