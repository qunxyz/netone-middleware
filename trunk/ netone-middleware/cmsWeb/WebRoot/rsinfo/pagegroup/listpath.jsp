...
<html>
	<head>
		...
		function createmodel(){
		  window.open('/cmsWeb/infomodelnew.do?path=${pathreal}');
		}
		
		function copydo(){
		  window.open('/cmsWeb/rsinfo/pagegroup/Copy.jsp?id=${upo.id}');
		}
		...
		function viewmodel(modelid,mode){
		  var url1='/cmsWeb/portal.do?toolbar=true&border=true&id='+modelid+'&portalmode=1';
		  var url2='/cmsWeb/portal.do?border=true&id='+modelid+'&portalmode=2';
		  var url3='/cmsWeb/portal.do?id='+modelid+'&portalmode=3';
				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="创建" onclick="createmodel();"
								class="butt">
							&nbsp;&nbsp;
							<input type="button" value="复制创建" onclick="copydo()" class="butt">
						...
						<tr>
							...
							<td nowrap>
								...
								<c:if test="${list.inclusion=='0'}">
									<a href="javascript:editmodel('${list.extendattribute}');">设计页组</a>
									<a href="javascript:viewmodel('${list.extendattribute}','1');">预览1</a>
