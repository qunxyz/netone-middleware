...
function managerthis(id,type,model) {
	...
	if(type=='path'){
		...
		function viewthismulti(id,model) {
			window.open("MSelectSvl?appid="+id+"&pagename="+model,'_blank', 'height=380, width=600, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
		}
		//显示但选择
