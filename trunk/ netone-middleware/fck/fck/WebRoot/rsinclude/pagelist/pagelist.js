...
function edit(chkid){
	if(chkid){
		window.open("PagelistModifySvl?task=edit&chkid="+chkid+"&pagename="+document.all.pagename.value,"usermod","width=1000,height=700,resizable=yes,left=150,status=yes,scrollbars=yes");
	} else {
		var k = 0;
		var value;
...
function view(chkid){
	window.open("PagelistViewSvl?chkid="+chkid+"&pagename="+document.all.pagename.value,"usermod","width=1000,height=600,resizable=yes,left=150,status=yes,scrollbars=yes");
}
function view1(chkid){
	window.open("PagelistViewSvl?chkid="+chkid+"&pagename="+document.all.pagename1.value,"usermod","width=1000,height=600,resizable=yes,left=150,status=yes,scrollbars=yes");
}
//执行删除
function del(chkid){
	if(chkid){
...
function newElemnt(){
	...
	window.open("PagelistAddSvl?id="+id+"&appid="+appid+"&ou="+ou+"&pagename="+document.all.pagename.value,"create",'width=1000,height=600,resizable=yes,left=300,top=180,status=yes,scrollbars=yes');
}
//进入上传页面
function newElementBinary(){
	window.open("PagelistUploadSvl?task=addfile&dirid="+document.all.id.value+"&appid="+document.all.appid.value+"&pagename="+document.all.pagename.value,"create",'width=600,height=450,resizable=yes,left=300,top=180,status=yes,scrollbars=yes');
}
//执行新建
function create(){
