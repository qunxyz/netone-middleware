  ...
  private var _height:Number;  
     ...
     if(!inputBox)
     {
         ...
         if (!hoursInputField)
         {
          hoursInputField = new TextInput();   
            hoursInputField.focusEnabled = false;
             ...
             hoursInputField.width=inputBox.width/3; 
             hoursInputField.height=this.height;
             hoursInputField.x=0;
             hoursInputField.y=0;     
      ...
      if(!sText)
      {
       ...
       sText.text=":";
       sText.height=this.height;
       sText.x= hoursInputField.width+hoursInputField.x;
       ...
       inputBox.addChild(sText);
         ...
         if (!minutesInputField)
         {
          minutesInputField = new TextInput();  
           ...
           minutesInputField.x=sText.x+sText.width;
           minutesInputField.height=inputBox.height;
           minutesInputField.width=inputBox.width/3;
    ...
    return str;
      ...
      public  override  function set height(height:Number):void{
		   ...
		   /*      // inputBox.height=height;
		         sText.height=height;        
                 hoursInputField.height=height;
                 minutesInputField.height=height */;
