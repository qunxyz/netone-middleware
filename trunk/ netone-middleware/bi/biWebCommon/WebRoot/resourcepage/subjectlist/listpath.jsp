				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							...
							&nbsp;&nbsp;
							<input type="button" value="新建分析主题" onclick="newds()" class="butt">
							&nbsp;&nbsp;
				...
				<table id="hang_table" width="96%" border="0" align="center"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
							    <c:if test="${list.inclusion != '1'}">
								<a href="javascript:done('${list.id}');"><font color='red'>[表格分析]</font></a>
								<a href="javascript:coreview('${list.extendattribute}');"><font color='green'>[描述文件]</a>
