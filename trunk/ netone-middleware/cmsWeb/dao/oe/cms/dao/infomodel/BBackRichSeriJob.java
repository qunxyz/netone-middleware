 ...
 * @author Bill Kratzer
 */
public final class BBackRichSeriJob implements Job {

	/**
	 * Quartz requires a public empty constructor so that the scheduler can
	 * instantiate the class whenever it needs.
	 */
	public BBackRichSeriJob() {
	}
	...
	public void execute(JobExecutionContext context)
		...
		System.out.println("计时点到，启动计划任务.......退会B空间");
		...
		List list2 = dao.fetchList(RichLevel._LEVEL_A);
