...
<html>
	<head>
		...
		//查询逻辑可以自定义扩展条件,SQL的子条件,name中文名称,naturalname 命名,日期属性created 有效属性active 1/0 扩展属性extendattribute
		function search(){
			var sqlcondition=" and name like '%X%'";
			document.getElementById("ext").value=sqlcondition;
...
<a href='javascript:newInclusion();'><font color='blue'>新建目录</font></a>
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="数据源创建" onclick="newElemnt();"
								class="butt">
							&nbsp;&nbsp;
