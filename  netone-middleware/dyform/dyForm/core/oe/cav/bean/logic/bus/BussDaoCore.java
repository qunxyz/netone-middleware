...
public interface BussDaoCore {
	 ...
	 * @return
	 */
	boolean export(BussObj bus, String condition, String type,
	 ...
	 * @return List 符合条件的对象数组
	 */
	public List queryObjects(BussObj obj, int from, int to, String conditionPre);
	 ...
	 * @return long
	 */
	public long queryObjectsNumber(BussObj obj, String conditionPre);
