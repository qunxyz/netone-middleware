...
<html>
  ...
  function hideTitle(){
	...
	<body>
		<FORM action="servlet/AjaxPageItemSvl?objtype=article" METHOD="POST">
					...
					<TR>
						<TD COLSPAN="2">
							...
							<MAP NAME="map_colorpalx">
								...
								<AREA COORDS="9,0,18,16" HREF="javascript:SendColor1('#FF99FF')">
								<AREA COORDS="0,0,9,16" HREF="javascript:SendColor1('#FFCCFF')">
							</MAP>
							<IMG SRC="<%=path%>/cms/include/css/colorpicker.gif" ISMAP
