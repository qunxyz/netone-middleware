...
public class Data {
	...
	public static HTMLCss getHTMLCss() {
		...
		css.setGroupTotal("BACKGROUND-COLOR: #d8e4f1; font: bold 10pt 宋体;");
		css.setHead("BACKGROUND-COLOR: #ffdead; font: bold 10pt 宋体;");
		css.setTotal("BACKGROUND-COLOR: #d8e4f1; font: bold 10pt 宋体;");
		css.setTitle("font: bold 15pt 宋体;");
	...
	public static PDFCss getPDFCss() {
		...
		try {
			...
			BaseFont bfChineseBold = BaseFont.createFont("STSong-Light",
					"UniGB-UCS2-H", BaseFont.NOT_EMBEDDED);
			Font FontChinese = new Font(bfChinese, 10, Font.NORMAL);
			Font FontChineseBold = new Font(bfChineseBold, 10, Font.BOLD);
			// ******************end 定义pdf中文字体*****************
