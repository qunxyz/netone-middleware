...
<HTML>
	<HEAD>
		...
		function done(){
			...
			this.document.forms[0].action="Show3.do?task=final";
		...
		function openfileselect(){
			window.open('<%=basePath%>MSelectSvl?appname=FILE&pagename=file','附件选择')
		    selectmode='file';
		}
		...
		function manageresourse(){
		    window.open('<%=basePath%>PagelistpathRightSvl?pagename=pagelistx&appname=FILE','资源管理');
		}
		function change(){
