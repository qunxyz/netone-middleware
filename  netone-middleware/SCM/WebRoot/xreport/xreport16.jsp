	...
	border-top: 1px dashed #E3E3E3;
		...
		/***
		    ...
		    **/
			...
			form1.action="<c:url value='/reportx16.do?method=query' />"+formatstr;
			form1.target="_blank";
			form1.method="POST";
			form1.submit();
			/***
					...
					<div id="tabs-1">
						<form id="_xreport_form">
							<input type="hidden" id="naturalname" name="naturalname"
								value="REPORTQ.REPORTQ.CXZD.FXKCMXB" unselectable="off"
								onFocus="this.select()" />
								...
								<tr class="form_tr" unselectable="off" onFocus="this.select()">
									<td class="form_td" unselectable="off" onFocus="this.select()"
										...
										<div class="form_fieldcontent" style="width: 196px">
											<div class="form_fieldcaption" align="left" title="分销柜组"
												style="width: 60px;">
												分销柜组:
											</div>
