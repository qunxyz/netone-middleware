...
public class UploadFileAction extends HttpServlet {
	...
	private int saveFile(String id, String userCode,
	 ...
	 String	sqlStr="INSERT INTO iss.t_file (unid, d_unid, u_unid, f_size, f_type, `address`, filename," +
			"updatetime,note)VALUES('"+UUID.randomUUID().toString().replaceAll("-", "")+"', '"+id+"', '"+userCode+"', '"+size+"', '"+type+"', '"+address+"', '"+filename+"', '"+TimeUtil.formatDateTime(new Date())+"', '用户"+userName+"创建!');";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	   ...
	   if (!fileItem.isFormField()) { 
		...
		path += "\\"+ TimeUtil.formatDate(new Date(), "yyyyMM");
