	...
	<div id="div_1"></div>
		...
		<div id="panel" style='width: 100%; height: 100%;'> 
				...
				<form id="planform" action="" method="post">
					...
					<table class="mainPI" >
						<tr>
							...
							<td colspan="3">
								<input class="text" type="text" style="width: 80%;" id="purchaseIllustrate" name="purchaseIllustrate" value="${shopping.purchaseIllustrate}" readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<td nowrap="nowrap" class="labelPI">
							...
							<td>	
										<input type="text" id="operateTime" name="operateTime"
											...
											style="width: 160px"
											onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" class="Wdate" disabled="disabled"/>
			...
			<table class="main" width="100%">
				...
				<tr>
					<td nowrap="nowrap" class="label_2" width="100%" height="700"><iframe name="myframe" id="myframe" src="http://netone.oesee.org:81/wfweb/listRuntimeprocess.do?runtimeid=${runtimeid}" width="100%" height="700" frameborder="0"></iframe></td>
				</tr>
			</table>
			</div>
		</div>
...
function _closeOpenerWin(){
	...
	function _auditnext2(ids,values,texts){
		var msgTip = Ext.MessageBox.show({
		 ...
		 Ext.Ajax.request({
	        url: "<c:url value='/shopping/shopping.do?method=onAudit' />",
	        // 请求的服务器地址
	        form: 'planform',
	        params:{
	        	values:values,
