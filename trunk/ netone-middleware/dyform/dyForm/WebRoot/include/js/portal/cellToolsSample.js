...
function addEleCore(selegroupValue,path) {
	window.open("/cmsWeb/blog/AddPage.jsp?pagepath="+path, "_BlkDsa", "height=500, width=400, top=200, left=300, toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no");
}
