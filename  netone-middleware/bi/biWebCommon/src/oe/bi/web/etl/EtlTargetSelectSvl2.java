...
public class EtlTargetSelectSvl2 extends HttpServlet {

	static Log log = LogFactory.getLog(EtlTargetSelectSvl2.class);

	/**
	 * Constructor of the object.
	 */
	public EtlTargetSelectSvl2() {
		super();
	}
		...
		if (method.equals("targetElementList")) {
			...
			if (tglist != null) {
				...
				for (int i = 0; i < tglist.size(); i++) {
					...
					sb.append("{" + tg.getNativeid() + "}");
					sb.append("=");
					sb.append(tg.getTragetname());
					sb.append("{");
					sb.append(tg.getTragetJavatype());
					sb.append("}");
				}
