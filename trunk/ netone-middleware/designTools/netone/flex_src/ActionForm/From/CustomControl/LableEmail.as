package ActionForm.From.CustomControl
{
	...
	import mx.core.*;
	public class LableEmail extends UIComponent
	{
		...
		public var _length:String="50";
		public var _PLANB:String;
		public var _ID:String;
		public var _type:String="邮箱";
		[Bindable]
   ...
   protected override function createChildren():void{
		super.createChildren();
                  ...
                  isEmail(_textinput.text);
	 		       addChild(_textinput);
	 		this.width=_lable.width+_textinput.width;
	 		this.height=_height; 
	 		var i:int=Math.round(Math.random()*(2000-1000))+1000;    
	 		this.name="LableText"+i;
	 		this.id="06";
		}
		public	function isEmail(strEmail:String):Boolean {
