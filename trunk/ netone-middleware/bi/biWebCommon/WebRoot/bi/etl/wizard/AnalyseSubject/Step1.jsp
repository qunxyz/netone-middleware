...
<HTML dir="LTR" lang="zh-CN">
	<HEAD>
		...
		function forward(){
			//history.go(-1);
			document.additem.action="<%=path%>/NextAnalyse.do?task=Step";
	...
	<BODY bgcolor="#FFFFFF">
		<FORM ACTION="" METHOD="POST" name="additem">
							...
							<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
								...
								<TR>
									<TD ALIGN="LEFT">
										...
										&nbsp;&nbsp;&nbsp;
										<FONT CLASS="OecInlineInfo">第 6 步, 共 10 步&nbsp;&nbsp;</FONT>
			...
			<DIV
				...
				<!-- Start--Body---- 功能内容定义  --->
				   	过滤类型：
				   	<input type="radio" name="filtertype" onclick="clears();" value="0" ${fo.filtertype==0?"checked":fo.filtertype==""?"checked":""}>无过滤
				   	<input type="radio" name="filtertype" onclick="clears();" value="2" ${fo.filtertype==2?"checked":""}>门限值
				<!-- End --Body---- 功能内容定义  --->
			</DIV>
			<CENTER>
				<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="90%">
