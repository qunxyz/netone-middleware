...
public class ClassUtils {
    ...
    public static final Comparator propertyDescriptorNameComparator;
    ...
    static {
        ...
        propertyDescriptorNameComparator = new Comparator() {
     ...
     * @return Classes for supplied names.
     * @throws ClassNotFoundException
     */
    ...
    public static PropertyDescriptor[] introspect(Class beanClass,
        ...
        try {
            ...
            Arrays.sort(propDescs, propertyDescriptorNameComparator);
    ...
    public static String[] namesForClasses(Class[] parmTypes) {
        ...
        for (int i = 0, dims = 0; i < parmTypes.length; i++, dims = 0) {
            ...
            if (dims != 0) {
                StringBuffer sb = new StringBuffer(className.length() + 2 * dims);
                sb.append(className);
