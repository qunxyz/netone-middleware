...
function managerthis(id,type,model) {
	...
	if(type=='path'){
		...
		function viewthis(id,model) {
			window.open("SelectSvl?appid="+id+"&pagename="+model,'_blank', 'height=380, width=600, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
		}
		//显示多选择
		function viewthismulti(id,model) {
			window.open("/dyForm/MSelectSvl?appname="+id+"&pagename="+model,'_blank', 'height=380, width=600, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
		}
		//显示但选择
		function viewthissingle(id,model) {
			window.open("SSelectSvl?appid="+id+"&pagename="+model,'_blank', 'height=380, width=500, top=0, left=0, toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no');
		}
