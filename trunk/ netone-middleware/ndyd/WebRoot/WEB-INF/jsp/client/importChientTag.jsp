...
<script>
  var toolbar = new Ext.Toolbar([
   ...
   function onSaveButton(){
	  ...
	  var arrayList=importFileObj.value.split(".");
	   if(arrayList[1]!='xls'){
	    ...
	    Ext.Ajax.request({
					url :'<c:url value="/client/import.do?method=onImportClientTagFile"/>',//请求的服务器地址
   ...
   function dowanLoad(){
       openWinCenter('下载','<c:url value="/client/import.do?method=onDownLoadClientTagFile"/>', 500,250,true);
   } 
