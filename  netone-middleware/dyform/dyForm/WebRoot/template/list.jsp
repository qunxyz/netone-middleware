		...
		<h:form method="post" action="/data/data/list">
			...
			<table width="100" border="0" cellspacing="0" cellpadding="1"
				...
				<tr>
					...
					<td>
						<h:submit ui="expIc" value="导出"
							action="/data/showdata/exportview.do" target="_blank"
							styleClass="buttonOnTable" />
					</td>
					<td>
					...
					<td>
						<h:submit ui="modifyIc" value="修改"
							action="/data/showdata/modifyview.do" target="_target"
							validate="selectone" styleClass="buttonOnTable" />
					</td>
					<td>
						<h:submit ui="deleteIc" value="删除" action="/data/data/dropope.do"
							target="_self" validate="deleteConfig" styleClass="buttonOnTable" />
					</td>
					<td>
					...
					<td>
						<h:submit ui="backIc" value="返回上一级"
							action="/data/data/backtofather.do" target="_self"
							styleClass="buttonOnTable" />
					</td>
				</tr>
