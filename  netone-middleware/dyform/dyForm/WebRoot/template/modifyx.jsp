...
<jsp:directive.page import="oe.cav.bean.logic.form.FormDao" />
<jsp:directive.page import="oe.cav.bean.logic.bus.FormEntry" />
<jsp:directive.page import="oe.cav.bean.logic.bus.BussDao" />
...
<%
	...
	TCsBus busForm = (TCsBus) bussDao.loadObject(
			formcode, new Long(
			lsh));
	List columnListAll = formDao
...
<html>
	...
	<body onLoad="hidenCheckRef()">
		<form name="dyDataForm" method="post" action="/dyForm/data/showdata.do;jsessionid=C7E9C9FFC657B91E65D344E8C0BCCC80"><table width="100%"><tr style="display:none">
<td>null</td>
