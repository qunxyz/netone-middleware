					...
					<div id="tabs-1">
						<form id="_xreport_form">
							<input type="hidden" id="naturalname" name="naturalname"
								value="REPORTQ.REPORTQ.FXGL.SSXTTJB" unselectable="off"
								onFocus="this.select()" />
							<table id="xreport" name="xreport" class="table_form" width="392"
										...
										<div class="form_fieldcontent" style="width: 392px">
											...
											<div class="form_fieldinput" style="width: 332px;"
												...
												<select id="repselect9" name="repselect9"
													style="width: 295.0px">
													<option value="小品名" selected="selected">
														小品名
													</option>
													<option value="分销商" >
														分销商
								...
								<tr class="form_tr" unselectable="off" onFocus="this.select()">
									<td class="form_td" unselectable="off" onFocus="this.select()"
										nowrap="nowrap">
										<div class="form_fieldcontent" style="width: 392px">
											<div class="form_fieldcaption" align="left" title="销退单号"
												style="width: 60px;">
												销退单号:
											</div>
											<div class="form_fieldinput" style="width: 332px;"
								...
								<tr class="form_tr" unselectable="off" onFocus="this.select()">
									<td class="form_td" unselectable="off" onFocus="this.select()"
										nowrap="nowrap">
										<div class="form_fieldcontent" style="width: 392px">
											<div class="form_fieldcaption" align="left" title="销退日期"
												style="width: 60px;">
												销退日期:
											</div>
											<div class="form_fieldinput" style="width: 332px;"
								...
								<tr class="form_tr" unselectable="off" onFocus="this.select()">
									<td class="form_td" unselectable="off" onFocus="this.select()"
										...
										<div class="form_fieldcontent" style="width: 196px">
											<div class="form_fieldcaption" align="left" title="销退属性"
												style="width: 60px;">
												销退属性:
											</div>
