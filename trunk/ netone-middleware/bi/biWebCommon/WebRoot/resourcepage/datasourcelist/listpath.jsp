				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							...
							<input type="button" value="新建数据源" onclick="newElemnt()" class="butt">
							&nbsp;&nbsp;
							&nbsp;
							<input type="button" value="上传数据源" onclick="newElementBinary();"
								class="butt">
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								...
								<a href="javascript:checkthis('${list.naturalname}','${list.extendattribute}','${list.id}');">选择</a>
							</td>
						</tr>
					</c:forEach>
				</table>
