...
<html>
	<head>
		...
		<SCRIPT type="text/javascript" src="<%=path%>\include\js\modelshow\showmodel.js"></SCRIPT>
...
-->
	...
	<body>
		...
		<div id="templatediv" name="templatediv" class="floatdiv" style="display:none ; float:left;  height: 50px; overflow: visible; border: 0; margin: 1px; word-wrap: break-word; ">
			loading...
		</div>
