...
<html>
	...
	<h3>标准公告-横向布局</h3>
		...
		<b>测试例子</b><br>
		使用动态表单标签，获得数据，显示页面. 其中为了显示不同新闻分类的数据需要在URL里加上 fatherlsh参数
		<hr>
						...
						<c:forEach items="${mydata}" var="data">
							<tr>
								<td>
									...
									<br>
									<strong>
									<a href='javascript:link("${fn:substring(data.extendattribute,6,38)}","${fn:substring(data.extendattribute,47,79)}")'><font color='#0066CC' size='2'>${data.column3}</font></a>
									</strong>
								</td>
							</tr>
