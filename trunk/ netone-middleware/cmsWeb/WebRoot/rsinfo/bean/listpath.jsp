...
<html>
	<head>
		...
		function monitor(id){
			window.open('/cmsWeb/RmiBeanViewSvl?id='+id,'_blank');
		}
		</script>
	</head>
				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="注册Bean" onclick="newElemnt();"
								class="butt">
							&nbsp;&nbsp;
				...
				<table id="hang_table" width="96%" border="0" align="center"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								<a href="javascript:monitor('${list.id}');"><font
									color='red'>[监控管理]</font>
								</a>
