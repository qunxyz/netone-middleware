			...
			<form action="" method="post" name="form1">
				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						...
						<td colspan='7'>
							<input type="button" value="创建图片目录" onclick="newInclusion();"
								class="butt">
							&nbsp;&nbsp;
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							...
							&nbsp;&nbsp;
							<input type="button" value="上传图片" onclick="newElementBinary();"
								class="butt">
							&nbsp;&nbsp;
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								...
								<c:if test="${list.inclusion != '1'}">
									<a href="javascript:view('${list.id}');"><img
											src="DownloadSvl?fileid=${list.id}" width='50' height='50' />
									</a>
								</c:if>
							</td>
							<td nowrap>
