...
<a href='javascript:newInclusion();'><font color='blue'>新建目录</font></a>
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="新建页模板" onclick="window.open('/cmsWeb/cellModelDIY.do?opeType=view&pathname=${pathreal}','_blank')"
								class="butt">
				...
				<table id="hang_table" width="96%" border="0" align="center"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								<a href="/cmsWeb/TemplateExeSvl?cellid=${list.extendattribute}&naturalname=${list.naturalname}" target='_blank'>测试</a>
								<a href="/cmsWeb/cellModelDIY.do?opeType=view&jppmid=${list.extendattribute}"  target='_blank'>修改</a>
								
								<a href="javascript:del('${list.id}');">删除</a>
								<a href="javascript:checkthis('${list.naturalname}');">选择</a>
							</td>
						</tr>
					</c:forEach>
				</table>
