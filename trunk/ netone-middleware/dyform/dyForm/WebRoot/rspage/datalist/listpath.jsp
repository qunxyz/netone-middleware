	...
	<body style="font-size: 12px;margin: 22px">
		<div style="width: 100%;height: 100%">
			<form action="" method="post" name="form1">
				...
				<table width="80%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="新建维度数据" onclick="newInclusion();"
								class="butt">
				...
				<table id="hang_table" width="80%" border="0" align="center"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								...
								<a
									href="javascript:checkthis('${list.naturalname}','${list.name}');"><font
									color='red'>[选择]</font> </a>
							</td>
						</tr>
					</c:forEach>
