						...
						<tr>
							...
							<td>
								<select name="type_" id="type_" style="width: 186px;">
									<option value="subject">需求名称</option>
									<option value="groupLevel">集团价值等级</option>
									<option value="apply">申请项目</option>
								</select>
							</td>
						</tr>
						<tr>
   ...
   function onSaveButton(){//保存
   	var type_ = document.getElementById('type_').value;
   		if(validateForm()){
              ...
              Ext.Ajax.request({
						url :"<c:url value='/common/systemConfig.do?method=onSavaOrUpdate' />"+"&type="+type_,//请求的服务器地址
