						...
						<div style="width: 100%;height: 100%;overflow: auto;">
							<c:if test="${root != null}">
								<script type="text/javascript">
				  					var functree = new WebFXLoadTree("${root.name}","XMLFuncTreeSvl?parentid=${root.id}","javascript:nodeAction('${root.id}','${root.appid}','${root.ou}','${root.naturalname}','${root.parentdir}','${root.actionurl}','${root.extendattribute}')");
				  					functree.write();
				  					functree.expand();
