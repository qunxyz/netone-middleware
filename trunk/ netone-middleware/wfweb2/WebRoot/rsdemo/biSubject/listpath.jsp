...
<html>
	<head>
		...
		<script type="text/javascript" src="include/js/workflow/designnew.js"></script>
		<script type="text/javascript" src="include/js/workflow/soa.js"></script>
		<script type="text/javascript">
			var pathinfo='<%=basePath%>';
			...
			function inclusionlinkX(natrualname){
				window.open("PagelistRightSvl?pagename=pagelist&appname="+natrualname);
			}
				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="创建主题" onclick="newprocess('${pathreal}');"
								class="butt">
								<script type="text/javascript">
								//进入新建页面
function copyElemnt(){
	...
	window.open("PagelistAddSvl?id="+id+"&appid="+appid+"&ou="+ou+"&pagename=copyflow","create",'width=600,height=450,resizable=yes,left=300,top=180,status=yes,scrollbars=yes');
}
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								...
								<a href="javascript:choiceprocess5('${list.extendattribute}','<portal:envget envkey="WEBSER_SpeedyForm"/>');"><font
									color='blue'>[主题分析]</font>
								</a>
								<a href="javascript:choiceprocess6('${list.extendattribute}','<portal:envget envkey="WEBSER_SpeedyForm"/>');"><font
									color='blue'>[修订主题]</font>
								</a>
								<a href="javascript:choiceprocess2('${list.extendattribute}');"><font
									color='green'>[查看主题]</font>
								</a>
								<a href="javascript:choiceprocess4('${list.extendattribute}');"><font
									color='green'>[主题流程实例]</font>
								</a>
								<a href="javascript:downprocess('${list.extendattribute}');"><font
									color='blue'>[主题流程描述]</font>
								</a>
