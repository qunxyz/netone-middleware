			...
			<form action="PagelistAddSvl?task=addsave" method="post">
				...
				<table width="96%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td width='300'>
							<input type="text" name="objecttype"
								value="BUSSENV.BUSSENV.PORTAL.CSS" class="textinput_td"
								readonly="readonly">
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan='2'>
							编辑样式:
							<a href='rsinfo/stylelist/style.txt' target='_blank'>[参考模板]</a>
							<textarea rows="20" cols="120" name="extendattribute"></textarea>
							<br>
