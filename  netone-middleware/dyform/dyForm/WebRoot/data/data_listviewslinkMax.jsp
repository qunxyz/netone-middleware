...
<html>
	...
	<body>
		...
		<h:form method="post" action="/data/showdata/subListviewslinkMax">
		

			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<c:datagrid ui="datagrid" width="100%" border="0" cellpadding="2" bordercolorlight="#000000" bordercolordark="#FFFFFF" styleClass="tableclass" event="enList" eventArgument="en" pageSize="30" headStyle="tdheadline">
							<c:datarow>
