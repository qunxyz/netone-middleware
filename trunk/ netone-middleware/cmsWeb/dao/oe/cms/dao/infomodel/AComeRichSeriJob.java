 ...
 * @author Bill Kratzer
 */
public final class AComeRichSeriJob implements Job {

	/**
	 * Quartz requires a public empty constructor so that the scheduler can
	 * instantiate the class whenever it needs.
	 */
	public AComeRichSeriJob() {
	}
	...
	public void execute(JobExecutionContext context)
		...
		System.out.println("计时点到，启动计划任务.......进级A空间");
		...
		List list = dao.fetchList(RichLevel._LEVEL_B);
		...
		for (int i = 0; i < comeANumValue; i++) {
			...
			modelPre.setLevels(RichLevel._LEVEL_A);
