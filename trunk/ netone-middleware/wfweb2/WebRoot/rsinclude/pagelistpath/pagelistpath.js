...
function newInclusion(){
	...
	window.open("PagelistAddSvl?inclusion=1&task=addx&id="+id+"&appid="+appid+"&ou="+ou+"&pagename="+document.all.pagename.value,"create",'width=600,height=450,resizable=yes,left=300,top=180,status=yes');
}
//进入新建子目录页面
