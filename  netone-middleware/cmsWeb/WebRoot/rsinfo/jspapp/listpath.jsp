...
<html>
	<head>
		...
		function test(id,active){
		    if(active=='0'){
		      window.open('/cmsWeb/_seu9'+id+".jsp");
		    }else{
		    window.open('/cmsWeb/'+id+".jsp");
		    }
				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="新建页程序" onclick="newElemnt();"
								class="butt">
							&nbsp;&nbsp;
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<c:if test="${list.inclusion != '1'}">
								...
								<a href="javascript:test('${list.id}','${list.active}');"><font color='red'>[测试]</font></a>
