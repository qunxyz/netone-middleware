...
<HTML dir="LTR" lang="zh-CN">
	<HEAD>
		...
		function nextsubmit(){
			...
			if(document.all.timeResult.length == 0){
				alert("没有选择时间!");
				return ;
			}
			if(isNaN(document.all.timeResult.value)){
				alert("时间必须为数字!");
				return;
			}
			...
			var timeResult = document.all.timeResult.value;
			var unit = document.all.unit.value;
			if(unit=='day'){
				var tmpv = timeResult*24;
				document.all.timeResults.value="#"+tmpv+"#";
			} else {
				document.all.timeResults.value="#"+timeResult+"#";
			}
			document.additem.submit();
		...
		function submitCalendar(){
	  		...
	  		if(startTime && endTime){
				...
				timeResult.add(new Option("#"+startTime+"#","#"+startTime+"#"));
				timeResult.add(new Option("#"+endTime+"#","#"+endTime+"#"));
	  		} else{
	  			alert("未选择时间范围！")
	  		}
		}
										...
										<td valign="top">
											...
											<div id="calendardiv" style="width:100%">
												...
												<div style="margin-top: 5">
													...
													<!-- 间隔 -->
													<!-- 间隔类型：增长类型-->
													<select name="selpoint2" onChange="timePartCheck();"
														style="display:none">
													...
													<!--时段-->
													<select name="hour" style="display:none">
												...
												<input type="text" name="selecttime1" onFocus="calendar();"
													style="width:120;display:none" value="${fo.selecttime1}">
												<br>
												<!--结束-->
												<input type="text" name="selecttime2" onFocus="calendar();"
													style="width:120;display:none" value="${fo.selecttime2}">
												<input type="button" class="butt" value="确定"
													onclick="btnAction_submitCalendar()" style="display:none">
												<!-- 连续 -->
										...
										<td height="80">
											<table>
												...
												<tr>
													...
													<td>
														<input type="text" name="timeResult" value="${fo.timeResult}">
														<span style="width: 18px; border: 0px solid red;"> <select
																name="r00" style="margin-left: -100px; width: 118px;"
																onChange="document.all.timeResult.value=this.value">
														...
														<select name="unit">
															<option value="hour" ${fo.unit=='hour'?"selected":""}>小时</option>
															<option value="day" ${fo.unit=='day'?"selected":""}>天</option>
														</select>
													</td>
												</tr>
											</table>
