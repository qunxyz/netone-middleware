	...
	border-top: 1px dashed #E3E3E3;
		...
		/***
		    ...
		    **/
			...
			form1.action="<c:url value='/reportx18.do?method=query' />"+formatstr;
			form1.target="_blank";
			form1.method="POST";
			form1.submit();
			/***
								...
								<tr class="form_tr" unselectable="off" onFocus="this.select()">
									<td class="form_td" unselectable="off" onFocus="this.select()"
										...
										<div class="form_fieldcontent" style="width: 196px">
											<div class="form_fieldcaption" align="left" title="流水号"
												style="width: 48px;">
												流水号:
											</div>
											<div class="form_fieldinput" style="width: 148px;"
												align="left">
												<input type="hidden" id="repstrdim6"
													name="repstrdim6" value="=" unselectable="off"
													onFocus="this.select()" />
