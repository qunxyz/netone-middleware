					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								...
								<a href="javascript:viewthis('${list.id}','pagelist');">选择树</a>
								<a href="javascript:viewthismulti('${list.id}','pagelist');">多选择</a>
								<a href="javascript:viewthissingle('${list.id}','pagelist');">单选择</a>
								<a
