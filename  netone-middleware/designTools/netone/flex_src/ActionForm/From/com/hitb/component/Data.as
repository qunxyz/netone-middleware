package ActionForm.From.com.hitb.component
{
	...
	public  class Data extends Canvas
	{
		...
		public function Data()
		{
		   ...
		   GlobalManager.getInstance().addEventListener(Data.Event_data,onMOUSEDOWN);
		}
	  ...
	  public function clickevent(event:ListEvent):void  
		{      
	     ...
	     case 7:   
		       ...
		       //弹出扩展属性编辑窗口
		      var titleWin:popextend=new popextend();
		         PopUpManager.addPopUp(titleWin,this.parent.parent.parent.parent, true);
       ...
       case 14:
		        ...
		        { 
		          var pb:PlanBcontent=PopUpManager.createPopUp(this.parent.parent.parent.parent, PlanBcontent, true) as PlanBcontent; 
		       ...
		       { 
		          ...
		          PopUpManager.addPopUp(kv,this.parent.parent.parent.parent,true);
	 ...
	 public function onMOUSEDOWN(Component:GlobalEvent):void{
	    ...
	    public static var  refresh_data:String="刷新数据";
        public static var  ITEM_CLICK:String="修改数据";
        public static var Event_popextend:String="发生属性";
        public static var Event_revamp:String="修改属性";
        public static var Event_summarytype:String="发送汇";
	}
