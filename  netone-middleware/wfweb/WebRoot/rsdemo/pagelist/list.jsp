		...
		<div style="width: 100%;height: 100%">
			<form action="" method="post" name="form1">
				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td nowrap>
							<a href='javascript:searchtree();'><font color='blue'>选择路径</font>
							</a>
						</td>
						<td width='100' >
				...
				<table id="hang_table" width="96%" border="0"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								<a href="javascript:createSoax('${list.id}');"><font color='blue'>[配置活动服务]</font></a>
								<a href="javascript:createSoa4('${list.id}');"><font color='#999999'>[活动服务配置]</font></a>
								<!-- <a href="javascript:createSoa2('${list.id}');"><font color='green'>[活动服务配置]</font></a> -->
