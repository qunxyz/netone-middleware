...
import com.report.chart.bar.impl.Bar3DImpl;
...
public class Bar3DTest {
	public static JFreeChart todo() {
		...
		JFreeChart chart = bar.createChart("Bar Chart 3D Demo", "Category",
	...
	public static void main(String[] args) {
		...
		ChartCommon.saveChartAsJPEG("Bar3DChart.jpg", todo());
