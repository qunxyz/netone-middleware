...
<HTML dir="LTR" lang="zh-CN">
	...
	<BODY bgcolor="#FFFFFF">
		<FORM ACTION="<%=path%>/NextAnalyse.do?task=First" METHOD="POST" name="additem">
			...
			<input type="hidden" name="selectedDimValue" value="${fo.selectedDimValue}">
			<input type="hidden" name="levelname" value="${fo.levelname}">
			<input type="hidden" name="dimResultValue" value="${fo.dimResultValue}">
										...
										<td valign="top">
											...
											<div id="calendardiv" style="width:100%">
												...
												<div style="margin-top: 5">
													...
													<!-- 间隔 -->
													<!-- 间隔类型：增长类型-->
													<select name="selpoint2" onChange="timePartCheck();" style="display:none">
														...
														<option value="3" ${fo.selpoint1==3?"selected":fo.selpoint1==''?"selected":""}>
															日
														</option>
													...
													<select name="hour" style="display:none">
														 <c:forEach var="item" begin="0" end="23">
														 	<option value="${item}" ${fo.hour==item?"selected":""}>${item}</option>
													    </c:forEach>
													</select>
