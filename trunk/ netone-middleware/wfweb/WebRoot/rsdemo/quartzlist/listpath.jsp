				...
				<table width="96%" border="0" align="center" cellpadding="5"
					...
					<tr>
						<td colspan='9' align='right' nowrap>
							&nbsp;&nbsp;
							<input type="button" value="新建任务" onclick="createSoa3();"
								class="butt">

							&nbsp;&nbsp;

							<input type="button" name="btnmodify" value="修 改"
								onclick="editSoa3();" class="butt">
							&nbsp;&nbsp;
				...
				<table id="hang_table" width="96%" border="0" align="center"
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td nowrap>
								<a href="javascript:startNow('${list.id}','${list.name}');"><font
									color='red'>[启动]</font> </a>
								<a href="javascript:editSoa3('${list.id}');">修改</a>
								<a href="javascript:del('${list.id}');">删除</a>
								<a href="javascript:pause('${list.id}');">休眠</a>
								<a href="javascript:resume('${list.id}');">唤醒</a>
								<a href="javascript:shutdown('${list.id}');">停止</a>
							</td>
						</tr>
					</c:forEach>
				</table>
