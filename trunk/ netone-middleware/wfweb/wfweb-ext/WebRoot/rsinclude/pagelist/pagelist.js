...
function edit(chkid){
	if(chkid){
		window.open("PagelistModifySvl?task=edit&chkid="+chkid+"&pagename="+document.all.pagename.value,"usermod","width=700,height=450,resizable=yes,left=150,status=yes,scrollbars=yes");
	} else {
		var k = 0;
		var value;
...
function newElemnt(){
	...
	window.open("PagelistAddSvl?id="+id+"&appid="+appid+"&ou="+ou+"&pagename="+document.all.pagename.value,"create",'width=600,height=450,resizable=yes,left=300,top=180,status=yes,scrollbars=yes');
}
...
function copyElement(){
	...
	window.open("PagelistCopySvl?id="+id+"&pagename="+document.all.pagename.value,"copy",'width=600,height=450,resizable=yes,left=300,top=180,status=yes,scrollbars=yes');
}
