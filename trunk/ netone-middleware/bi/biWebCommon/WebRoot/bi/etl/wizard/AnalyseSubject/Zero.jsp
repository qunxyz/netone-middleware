	...
	<BODY bgcolor="#FFFFFF">
		<FORM ACTION="<%=path%>/NextAnalyse.do?task=BeforeFirst" METHOD="POST"
							...
							<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%">
								...
								<TR>
									<TD ALIGN="LEFT">
										...
										&nbsp;&nbsp;&nbsp;
										<FONT CLASS="OecInlineInfo">第 1 步, 共 10 步&nbsp;&nbsp;</FONT>
			...
			<DIV
				...
				<hr>
				<br>
				<FONT CLASS="OecInstructionText">帮助提示:名称是该主题分析的唯一识别名,请使用英文来填写。时间模式中,”固定时间“是指选择相关的时间点进行的分析，“时间范围”是指在规定的时间范围类进行分析范围内，“前N个时间”是指从当前开始前N个时间
					然后单击“下一步”。</FONT>
				<!-- End --Title----功能标题与提示---->
				<BR>
						...
						<tr>
							...
							<td>
								<input type="text" id="naturalname" name="naturalname" value="${fo.naturalname}"
									size='30'>  <font color='red'>${error}</font>[格式：字母开头后接字母或数字或下划线]
							</td>
						</tr>
						<tr>
							<td>
